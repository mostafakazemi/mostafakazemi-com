...
export const caseStudy = {
  ...
  summary:
    "A React and Next.js case study focused on e-commerce platform engineering for an online store builder supporting 6,000+ stores, 5M+ users, and roughly 10 trillion rial in monthly transaction volume.",
  technologies: [
    "React",
    "Next.js",
    "TypeScript",
  ...
  problem:
    "The platform needed frontend architecture that could support e-commerce flows, store-builder experiences, API integrations, and ongoing product changes at meaningful scale: 6,000+ stores, 5M+ users, and roughly 10 trillion rial in monthly transaction volume.",
  responsibilities: [
    "Owned React and Next.js frontend experiences for e-commerce and online store builder workflows.",
    "Unified reusable UI components and frontend patterns with TypeScript and Tailwind CSS.",
    ...
    "Drove performance, maintainability, and developer-experience improvements across frontend surfaces.",
    "Balanced product and engineering needs while keeping changes incremental and production-focused."
  ],
  challenges: [
    "Supporting product development across both modern Next.js surfaces and legacy React code paths.",
  ...
  results: [
    ...
    "Reduced repeated UI implementation through reusable components shared across platform areas.",
